...
export function TasksFooter() {
  ...
  return (
    <>
      {!isTasksListEmpty && (
        <footer className="flex justify-between max-sm:items-center max-sm:justify-center max-sm:flex-wrap max-sm:gap-4 px-4 py-2 bg-white border-t border-gray-200 sheets-effect">
          <span className="max-sm:flex-1 max-sm:border max-sm:border-gray-400 max-sm:rounded-[3px] max-sm:flex max-sm:justify-center" data-testid="tasks-left">{tasksLeft} itens left</span>
