        ...
        <li className="item_container">
            {
                ...
                <div className="editing_container" ref={editRef}> 
                    <input type="text" name="" className="editing_input" placeholder="Insira um novo título" onChange={handleChange}  onKeyDown={handleKeyDown} /> 
                </div> : 
                (
                    <>
                        <input
                        ...
                        {}
                        <div className="item_title" onDoubleClick={() => {
